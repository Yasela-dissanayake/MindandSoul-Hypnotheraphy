          ...
          <Card className="border-green-200">
            <CardContent className="p-8 text-center space-y-6">
              ...
              <p className="text-stone-600">
                Thank you for booking your hypnotherapy session. You will
        ...
        <div className="container mx-auto px-4">
          <div className="text-center space-y-4">
            ...
            <h1 className="text-3xl lg:text-4xl font-serif text-stone-800">
              Schedule Your Hypnotherapy Session
            </h1>
            <p className="text-stone-600 max-w-2xl mx-auto">
              Book your personalized hypnotherapy session in just a few simple
              steps. Choose your preferred service, date, and time.
            </p>
          </div>
        </div>
      </section>
                    ...
                    <div className="grid lg:grid-cols-2 gap-8">
                      <div className="space-y-4">
                        ...
                        <div className="text-xs text-stone-500 bg-blue-50 p-2 rounded">
                          <strong>Note:</strong> Sundays are closed. Saturday
                          ...
                          <div className="space-y-3">
                            ...
                            {selectedDate.getDay() === 6 && (
                              <p className="text-xs text-stone-500 bg-blue-50 p-2 rounded">
                                <strong>Saturday hours:</strong> 9:00 AM - 2:00
                                PM
                              </p>
                            )}
                          </div>
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
                      ...
                      <p className="text-sm text-amber-700">
                        Hypnotherapy is not a substitute for medical treatment.
                        If you have serious mental health concerns, please
                        consult with your healthcare provider. We may recommend
