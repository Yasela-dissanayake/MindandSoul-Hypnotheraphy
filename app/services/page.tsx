...
export default function ServicesPage() {
  ...
  const coreServices = [
    ...
    },
    {
      ...
      packages:
        "3 sessions: $260 (in-person) / $200 (online), 5 sessions: $445 (in-person) / $345 (online)",
    },
    {
      id: "animal-reiki",
      icon: Leaf,
      ...
      specialNote:
        "Special Pet & Parent Package: $190 (75 minutes) - includes healing for both you and your pet",
    },
    {
      id: "lama-fera",
      icon: Zap,
    ...
    },
    {
      ...
      shortDesc:
        "Explore your soul's journey and heal through wisdom of the past.",
      fullDesc:
    ...
    },
    {
      ...
      programs:
        "8-Week Program: $225, Daily Morning Sessions: $75/week, Group Circles: Inquiry for pricing",
    },
  ];
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {coreServices.map((service, index) => (
              <Card
                key={index}
                className="border-stone-200 hover:shadow-lg transition-shadow cursor-pointer"
              >
