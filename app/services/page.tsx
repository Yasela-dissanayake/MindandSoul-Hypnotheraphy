...
export default function ServicesPage() {
  ...
  const coreServices = [
    ...
    },
    {
      ...
      specialNote: "Pet & Parent Package includes healing for both you and your pet",
      bookable: true,
    },
    {
      id: "lama-fera",
    ...
    <div className="min-h-screen bg-stone-50">
                ...
                <CardContent className="p-6 space-y-4">
                  ...
                  <div className="space-y-2 text-xs text-stone-500">
                    ...
                    {service.pricing.single && (
                      <div className="font-semibold text-sage-600">${service.pricing.single} per session</div>
                    )}
                    ...
                    {service.pricing.eightWeekProgram && (
                      <div className="font-semibold text-sage-600">
                        8-Week Program: ${service.pricing.eightWeekProgram.price}
                      </div>
                    )}
                  </div>
                  ...
                  {service.bookable ? (
                    ...
                    <Link href="/contact">
                      <Button className="w-full bg-stone-600 hover:bg-stone-700 text-white">Inquire</Button>
                    </Link>
                  )}
                </CardContent>
              </Card>
      ...
      <section className="py-20 bg-stone-50">
        <div className="container mx-auto px-4">
          ...
          <Tabs defaultValue="clinical-hypnotherapy" className="max-w-6xl mx-auto">
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-start">
                  <div className="space-y-6">
                    ...
                    <div className="space-y-4 p-4 bg-sage-50 rounded-lg">
                      <h4 className="font-semibold text-stone-800">Pricing & Booking Options</h4>

                      {service.pricing.single && (
                        <div className="space-y-3">
                          <div className="border border-sage-200 rounded-lg p-3 bg-white">
                            <div className="flex justify-between items-center mb-2">
                              <span className="text-stone-700 font-medium">Single Session</span>
                              <span className="font-semibold text-sage-600">${service.pricing.single}</span>
                            </div>
                            ...
                            <div className="border border-sage-200 rounded-lg p-3 bg-white">
                              <div className="flex justify-between items-center mb-2">
                                <span className="text-stone-700 font-medium">
                                  {service.pricing.package.sessions} Sessions Package
                                </span>
                                <span className="font-semibold text-sage-600">${service.pricing.package.price}</span>
                              </div>
                              <div className="text-xs text-stone-500 mb-2">
                                Save $
                                {service.pricing.single * service.pricing.package.sessions -
                              ...
                              >
                                <Button size="sm" className="w-full bg-sage-600 hover:bg-sage-700 text-white">
                                  Book {service.pricing.package.sessions} Sessions
                                </Button>
                              </Link>
                            </div>
                          )}
                      ...
                      {service.pricing.inPerson && (
                        <div className="space-y-3">
                          ...
                          <div className="space-y-2">
                            <div className="border border-sage-200 rounded-lg p-3 bg-white">
                              <div className="flex justify-between items-center mb-2">
                                <span className="text-stone-700">Single Session</span>
                                <span className="font-semibold text-sage-600">${service.pricing.inPerson.single}</span>
                              </div>
                            ...
                            {service.pricing.inPerson.packages?.map((pkg, idx) => (
                              <div key={idx} className="border border-sage-200 rounded-lg p-3 bg-white">
                                <div className="flex justify-between items-center mb-2">
                                  <span className="text-stone-700">{pkg.sessions} Sessions Package</span>
                                  <span className="font-semibold text-sage-600">${pkg.price}</span>
                                </div>
                                <div className="text-xs text-stone-500 mb-2">
                          ...
                          {service.pricing.petParentPackage && (
                            <>
                              ...
                              <div className="space-y-3">
                                ...
                                <div className="space-y-2">
                                  <div className="text-sm text-stone-600 font-medium">In-Person Package:</div>
                                  <div className="border border-sage-200 rounded-lg p-3 bg-white">
                                    <div className="flex justify-between items-center mb-2">
                                      <span className="text-stone-700">Single Session</span>
                                      <span className="font-semibold text-sage-600">
                                  ...
                                  {service.pricing.petParentPackage.inPerson.packages?.map((pkg, idx) => (
                                    <div key={idx} className="border border-sage-200 rounded-lg p-3 bg-white">
                                      ...
                                      >
                                        <Button size="sm" className="w-full bg-sage-600 hover:bg-sage-700 text-white">
                                          Book Pet & Parent {pkg.sessions} Sessions
                                        </Button>
                                      </Link>
                                    </div>
                                  ))}
                                ...
                                <div className="space-y-2">
                                  <div className="text-sm text-stone-600 font-medium">Distance Package:</div>
                                  <div className="border border-sage-200 rounded-lg p-3 bg-white">
                                    <div className="flex justify-between items-center mb-2">
                                      <span className="text-stone-700">Single Session</span>
                                      <span className="font-semibold text-sage-600">
                                  ...
                                  {service.pricing.petParentPackage.distance.packages?.map((pkg, idx) => (
                                    <div key={idx} className="border border-sage-200 rounded-lg p-3 bg-white">
                                      ...
                                      >
                                        <Button size="sm" className="w-full bg-sage-600 hover:bg-sage-700 text-white">
                                          Book Pet & Parent Distance {pkg.sessions}
                                        </Button>
                                      </Link>
                                    </div>
                                  ))}
                      ...
                      {service.pricing.eightWeekProgram && (
                        <div className="space-y-2">
                          <div className="border border-sage-200 rounded-lg p-3 bg-white">
                            <div className="flex justify-between items-center mb-2">
                              <span className="text-stone-700">8-Week Program</span>
                              <span className="font-semibold text-sage-600">
                                ${service.pricing.eightWeekProgram.price}
                              </span>
                            </div>
                            <Link href={`/booking?service=${service.id}&program=8-week`}>
                              <Button size="sm" className="w-full bg-sage-600 hover:bg-sage-700 text-white">
                                Book 8-Week Program
                              </Button>
                            </Link>
                          ...
                          {service.pricing.recordedSessions && (
                            <div className="border border-sage-200 rounded-lg p-3 bg-white">
                              <div className="flex justify-between items-center mb-2">
                                <span className="text-stone-700">Recorded Sessions</span>
                                <span className="font-semibold text-sage-600">
                                  ${service.pricing.recordedSessions.price} per week
                                </span>
                              </div>
                              <Link href={`/booking?service=${service.id}&program=recorded`}>
                                <Button size="sm" className="w-full bg-sage-600 hover:bg-sage-700 text-white">
                                  Book Recorded Sessions
                                </Button>
                              </Link>
                            </div>
                          )}
                      ...
                      {service.specialPrograms && (
                        <div className="border-t border-sage-200 pt-4">
                          <h5 className="font-medium text-stone-800 mb-3">Special Programs</h5>
                          <div className="space-y-3">
                            {service.specialPrograms.map((program, idx) => (
                              <div key={idx} className="border border-sage-200 rounded-lg p-3 bg-white">
                                <div className="flex justify-between items-start mb-2">
                                  <div className="flex-1">
                                    <h6 className="font-medium text-stone-800">{program.name}</h6>
            ...
            {specializedServices.map((service, index) => (
              <Card key={index} className="border-stone-200 hover:shadow-lg transition-shadow">
                <CardContent className="p-6 space-y-4">
                  ...
                  <Link href="/contact">
                    <Button className="w-full bg-stone-600 hover:bg-stone-700 text-white">Send Inquiry</Button>
                  </Link>
                </CardContent>
              </Card>
            ))}
