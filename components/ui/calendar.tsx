  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected: "bg-sage-600 text-white hover:bg-sage-600 hover:text-white focus:bg-sage-600 focus:text-white",
        day_today: "bg-stone-100 text-stone-900",
        day_outside:
          "day-outside text-stone-400 opacity-50 aria-selected:bg-sage-100/50 aria-selected:text-stone-500 aria-selected:opacity-30",
